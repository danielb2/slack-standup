...
var xdg = process.env.XDG_CONFIG_HOME || Path.join(process.env.HOME, '.config');
var standup_dir = Path.join(xdg, Pkg.name);
var prefs_file = Path.join(standup_dir, 'slackrc.json');
